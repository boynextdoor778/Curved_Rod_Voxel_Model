function batch_export_mat_voxel_to_stl_444()
clear; clc;

%% ===================== PATH SETTINGS =====================
rootDir = fileparts(mfilename('fullpath'));  % current 4x4x4 folder
if isempty(rootDir); rootDir = pwd; end
addpath(rootDir);

srcMatDir = fullfile(rootDir, 'batch_curved_x', '4x4x4_mat');
...
%% ===================== STL SETTINGS ======================
% 100% physical size: 4x4x4 specimen is about 80 mm high.
