...
Optional: override INP_DIR from command line:
    abaqus cae noGUI=abaqus_batch_run_all.py -- "D:\\Simulation\\Curved_Rod_Voxel_Model\\Output"

Important:
    - Run this with "abaqus cae noGUI=...", not "abaqus python ...".
    - Keep WORK_ROOT on D drive or another large disk, not C drive.
    - Default folders are Abaqus_Work_light and Results_light so this test does not overwrite your stable results.
"""
...
DISP_Z = -16.0       # compression displacement in mm

# Stress-strain conversion
H0 = 80.0            # initial specimen height in mm
A0 = 80.0 * 80.0    # nominal cross-section area in mm^2
